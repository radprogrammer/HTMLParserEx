...
const
  EntityTable: array [0 .. 252 - 1] of TEntityItem = ((Key: '&nbsp;';
    Value: #32), (Key: '&iexcl;'; Value: WideChar(161)), (Key: '&cent;';
    Value: WideChar(162)), (Key: '&pound;'; Value: WideChar(163)),
    (Key: '&curren;'; Value: WideChar(164)), (Key: '&yen;';
    Value: WideChar(165)), (Key: '&brvbar;'; Value: WideChar(166)),
    (Key: '&sect;'; Value: WideChar(167)), (Key: '&uml;'; Value: WideChar(168)),
    (Key: '&copy;'; Value: WideChar(169)), (Key: '&ordf;';
    Value: WideChar(170)), (Key: '&laquo;'; Value: WideChar(171)),
    (Key: '&not;'; Value: WideChar(172)), (Key: '&shy;'; Value: WideChar(173)),
    (Key: '&reg;'; Value: WideChar(174)), (Key: '&macr;'; Value: WideChar(175)),
    (Key: '&deg;'; Value: WideChar(176)), (Key: '&plusmn;';
    Value: WideChar(177)), (Key: '&sup2;'; Value: WideChar(178)),
    (Key: '&sup3;'; Value: WideChar(179)), (Key: '&acute;';
    Value: WideChar(180)), (Key: '&micro;'; Value: WideChar(181)),
    (Key: '&para;'; Value: WideChar(182)), (Key: '&middot;';
    Value: WideChar(183)), (Key: '&cedil;'; Value: WideChar(184)),
    (Key: '&sup1;'; Value: WideChar(185)), (Key: '&ordm;';
    Value: WideChar(186)), (Key: '&raquo;'; Value: WideChar(187)),
    (Key: '&frac14;'; Value: WideChar(188)), (Key: '&frac12;';
    Value: WideChar(189)), (Key: '&frac34;'; Value: WideChar(190)),
    (Key: '&iquest;'; Value: WideChar(191)), (Key: '&Agrave;';
    Value: WideChar(192)), (Key: '&Aacute;'; Value: WideChar(193)),
    (Key: '&Acirc;'; Value: WideChar(194)), (Key: '&Atilde;';
    Value: WideChar(195)), (Key: '&Auml;'; Value: WideChar(196)),
    (Key: '&Aring;'; Value: WideChar(197)), (Key: '&AElig;';
    Value: WideChar(198)), (Key: '&Ccedil;'; Value: WideChar(199)),
    (Key: '&Egrave;'; Value: WideChar(200)), (Key: '&Eacute;';
    Value: WideChar(201)), (Key: '&Ecirc;'; Value: WideChar(202)),
    (Key: '&Euml;'; Value: WideChar(203)), (Key: '&Igrave;';
    Value: WideChar(204)), (Key: '&Iacute;'; Value: WideChar(205)),
    (Key: '&Icirc;'; Value: WideChar(206)), (Key: '&Iuml;';
    Value: WideChar(207)), (Key: '&ETH;'; Value: WideChar(208)),
...
var
  ...
  begin
    ...
    case sc.CurrentChar of
      ...
      begin
        DoError(Format('Could not resolve CSS Attribute operator [%d,%d]',
          [sc.LineNum, sc.ColNum]));
      end;
    end;
    ...
    if sc.CurrentChar = ']' then
      ...
      DoError(Format('Unable to parse attribute value [%d,%d]',
        [sc.LineNum, sc.ColNum]));
  end;
...
procedure THtmlElement._GetHtml(IncludeSelf: Boolean; Sb: TStringBuilder);
  ...
  begin
    if FTagName.Equals(cSpecialTagName_Text) or FTagName.Equals('#SCRIPT') or
      FTagName.Equals('#STYLE') or FTagName.Equals('#COMMENT') or
      FTagName.Equals('#DOCTYPE') or FTagName.Equals('#DOCUMENT') then
    begin
      Result := FContent;
    end
    else
...
function THtmlElement.SimpleCSSSelector(const selector: String)
  : IHtmlElementList;
var
  r: TIHtmlElementList;
begin
...
begin
  Result := System.Copy(SourceCode, index{$IF (LowStrIndex = 0)} +
    1{$ENDIF}, Count);
end;
  ...
  begin
    ...
    begin
      ...
      if Pos('@', LMattr) > 0 then
        LAttr := Format('[%s*=%s]', [LMattr.Replace('@', ''),
          GetValue('cvalue')])
    ...
    Inc(LPosition, Validation_re.MatchedOffset +
      Validation_re.MatchedLength - 1);
  end;
end;
